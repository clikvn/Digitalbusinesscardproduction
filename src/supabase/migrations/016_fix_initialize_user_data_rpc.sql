-- ============================================
-- FIX initialize_user_data() RPC FUNCTION
-- ============================================
-- PROBLEM: initialize_user_data() is the ACTUAL function called by the app
--          It inserts into user_share_settings without share_code column
-- ERROR: Line 176 & 189 in migration 015 missing share_code!
-- SOLUTION: Add share_code to both INSERT statements
...
BEGIN
  ...
  -- Create share settings WITH share_code column! ✅
  BEGIN
    INSERT INTO user_share_settings (
      user_id, 
      user_code, 
      group_id, 
      share_code,     -- ✅ Added this!
      visible_fields
    )
    VALUES
...
COMMENT ON FUNCTION public.initialize_user_data() IS 
  'RPC function called by app after signup to initialize user data. 
   Updated to include share_code in user_share_settings INSERT statements (both main and retry).';
